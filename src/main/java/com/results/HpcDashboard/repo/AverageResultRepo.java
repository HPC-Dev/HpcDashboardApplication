...
public interface AverageResultRepo extends DataTablesRepository<AverageResult, AverageResultId> {
    ...
    void updateAverageResult(String bm_name, String cpu_sku, int nodes, double avg,double perCorePerf,double perfPerDollar,double perfPerWatt, double cv, int count, String runType, String workload);
